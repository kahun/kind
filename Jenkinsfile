...
hose {
    ...
    DEV = { config ->
        ...
        doCustomStage(conf:config, buildToolOverride: [CUSTOM_COMMAND: 'mkdir -p /home/jenkins/agent/workspace/CTS/resources; tar zxvf bin/cloud-provisioner.tar.gz -C /home/jenkins/agent/workspace/CTS/resources/; chmod -R 0700 /home/jenkins/agent/workspace/CTS/resources/bin/cloud-provisioner'], stageName: "Extract cloud-provisioner binary")
