...
Si los archivos binarios necesarios no están presentes, se pueden instalar en _images/.loca/bin_ con el comando `make deps-ami`. Este directorio deberá agregarse a su _$PATH_.
