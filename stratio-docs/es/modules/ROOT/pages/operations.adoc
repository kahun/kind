...
Para actualizar la versión de _Stratio Cloud Provisioner_ de 0.2 a 0.3 debes ejecutar el _script_ `upgrade-provisioner_v0.3.py`. Puedes consultar la ayuda del _script_ con el siguiente comando:
