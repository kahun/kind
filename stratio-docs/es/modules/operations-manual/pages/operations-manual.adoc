...
Para actualizar la versión de _Stratio Cloud Provisioner_ de 0.3 a 0.4 se debe ejecutar el _script_ _upgrade-provisioner++_++.py_ desde el workspace con el que se instaló el cluster.
