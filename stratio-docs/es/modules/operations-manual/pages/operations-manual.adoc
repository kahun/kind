...
El cluster.yaml y el secrets.yml deben estar presentes en el workspace, si el cluster.yaml tiene otro nombre o está en otro path se puede especificar con el parámetro -d.
